...
\iffalse
\begin{mathpar}
\inferrule*[Left=\rref*{Pi}]{
  \inferrule*[Left=\rref*{Pi}]{
    \inferrule*[Left=\rref*{Pi}]{
      \inferrule*[Left=\rref*{Cumul}]{
           \ottmv{x}  \mathbin{:}   \kw{Level}\texttt{<} \gap   \omega    ,  \ottmv{y}  \mathbin{:}   \kw{U} \gap   \mathit{ \ottmv{x} }     \vdash   \mathit{ \ottmv{y} }   \mathrel{:}   \kw{U} \gap   \mathit{ \ottmv{x} }   
        \\\\
           \ottmv{x}  \mathbin{:}   \kw{Level}\texttt{<} \gap   \omega    ,  \ottmv{y}  \mathbin{:}   \kw{U} \gap   \mathit{ \ottmv{x} }     \vdash   \mathit{ \ottmv{x} }   \mathrel{:}   \kw{Level}\texttt{<} \gap   \omega   
      }{
           \ottmv{x}  \mathbin{:}   \kw{Level}\texttt{<} \gap   \omega    ,  \ottmv{y}  \mathbin{:}   \kw{U} \gap   \mathit{ \ottmv{x} }     \vdash   \mathit{ \ottmv{y} }   \mathrel{:}   \kw{U} \gap   \omega   
      }
    }{
         \ottmv{x}  \mathbin{:}   \kw{Level}\texttt{<} \gap   \omega    ,  \ottmv{y}  \mathbin{:}   \kw{U} \gap   \mathit{ \ottmv{x} }     \vdash    \mathit{ \ottmv{y} }   \to   \mathit{ \ottmv{y} }    \mathrel{:}   \kw{U} \gap   \omega   
    }
    \and
    \inferrule*[Right=\rref*{Univ}]{
        \ottmv{x}  \mathbin{:}   \kw{Level}\texttt{<} \gap   \omega     \vdash   \mathit{ \ottmv{x} }   \mathrel{:}   \kw{Level}\texttt{<} \gap   \omega   
    }{
        \ottmv{x}  \mathbin{:}   \kw{Level}\texttt{<} \gap   \omega     \vdash   \kw{U} \gap   \mathit{ \ottmv{x} }    \mathrel{:}   \kw{U} \gap   \omega   
    }
  }{
      \ottmv{x}  \mathbin{:}   \kw{Level}\texttt{<} \gap   \omega     \vdash    \Pi  \ottmv{y}  \mathbin{:}   \kw{U} \gap   \mathit{ \ottmv{x} }    \mathpunct{.}   \mathit{ \ottmv{y} }    \to   \mathit{ \ottmv{y} }    \mathrel{:}   \kw{U} \gap   \omega   
  }
  \and
  \inferrule*[Right=\rref*{Level}]{\dots}{  \cdot   \vdash   \kw{Level}\texttt{<} \gap   \omega    \mathrel{:}   \kw{U} \gap   \omega   }
}{
    \cdot   \vdash    \Pi  \ottmv{x}  \mathbin{:}   \kw{Level}\texttt{<} \gap   \omega    \mathpunct{.}   \Pi  \ottmv{y}  \mathbin{:}   \kw{U} \gap   \mathit{ \ottmv{x} }    \mathpunct{.}   \mathit{ \ottmv{y} }     \to   \mathit{ \ottmv{y} }    \mathrel{:}   \kw{U} \gap   \omega   
}
\end{mathpar}
\fi
...
\begin{mathpar}
  ...
  \inferrule[\ottdrulename{I'-Univ}]
    ...
    { \mathopen{\llbracket}   \kw{U} \gap   \ottmv{j}    \mathclose{\rrbracket}_{ \ottmv{i} } \searrow   \lbrace  \ottmv{z}  \mid   \exists  \ottnt{P}  \mathpunct{.}   \mathopen{\llbracket}   \mathit{ \ottmv{z} }   \mathclose{\rrbracket}_{ \ottmv{j} } \searrow  \ottnt{P}    \rbrace  }
  \and
  \inferrule[\ottdrulename{I'-UnivNe}]{~}{ \mathopen{\llbracket}   \kw{U} \gap  \ottnt{e}   \mathclose{\rrbracket}_{ \ottmv{i} } \searrow   \lbrace  \ottmv{z}  \mid   \mathbf{wne} \gap   \mathit{ \ottmv{z} }    \rbrace  }
\end{mathpar}
